...
const MyNotifications = ({ notificationsData }) => {
  ...
  const handleRemoveNotification = async (notificationId) => {
    // Changes in frontEnd
    const newNotifications = notifications.filter(notification => notificationId !== notification.id)
    setNotifications(newNotifications)
              ...
              <div className='flex justify-between items-center'>
                ...
                <div className='flex items-center'>
                  ...
                  <Tooltip color='danger' content='Remove Notification'>
                    <button className='outline-none' onClick={() => handleRemoveNotification(notification.id)}>
