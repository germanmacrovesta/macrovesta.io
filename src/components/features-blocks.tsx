...
export default function FeaturesBlocks() {
    return (
        <section className=" relative overflow-hidden">
            ...
            <div className="z-10 w-full bg-gradient-to-r from-deep_blue to-navy pointer-events-none py-4" aria-hidden="true">
                {/* <div className="relative z-10 px-4 sm:px-6 grid grid-cols-[auto_800px]"> */}
                <div className="relative z-10 px-4 sm:px-6 flex flex-col xl:flex-row">
                    ...
                    <div className="md:py-20 w-full xl:w-[800px] self-center">
                        {/* Section header */}

                        {/* Items */}
                        <div className="w-full xl:w-[800px] grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 items-start">
                            <div className="h-[100px] lg:h-[120px] xl:h-[100px] relative flex flex-col items-center p-6 bg-white rounded shadow-xl border border-grey-100 hover:scale-105 duration-500 text-center ">
                                {/* <div>
